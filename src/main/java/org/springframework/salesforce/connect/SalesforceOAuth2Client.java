...
public class SalesforceOAuth2Client {
     ...
     */
    protected AccessGrant postForToken(MultiValueMap<String, String> parameters) {
        ...
        if (accessGrant.getInstanceUrl() != null) {
            this.instanceUrl = accessGrant.getInstanceUrl();
        }
